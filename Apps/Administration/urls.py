...
from Apps.Agent.views import property_type_select, property_add, property_edit, property_delete
...
urlpatterns = [
    ...
    path('property/<int:pk>/edit/', property_edit, name='property_edit'),
